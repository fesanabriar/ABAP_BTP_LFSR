CLASS zcl_carga_biblioteca_7143 DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
  PUBLIC SECTION.
  ...
  PRIVATE SECTION.
ENDCLASS.
CLASS zcl_carga_biblioteca_7143 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_cat_7143,
          lt_catego    TYPE TABLE OF ztb_catego_7143,
          lt_clientes  TYPE TABLE OF ztb_cliente_7143,
          lt_clnts_lib TYPE TABLE OF ztb_clt_lib_7143,
          lt_libros    TYPE TABLE OF ztb_libro_7143.
******** ZTB_ACC_CATEG ********
    "fill internal table
    lt_acc_categ = VALUE #(
...
*   SAP BTP - ABAP en Cloud
*    Modelo de datos  20
    "Delete possible entries; insert new entries
    delete from ztb_acc_cat_7143.
    INSERT ztb_acc_cat_7143 FROM TABLE @lt_acc_categ.
******** ZTB_CATEGO ********
    "fill internal table
    lt_catego = VALUE #(
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_7143.
    INSERT ztb_catego_7143 FROM TABLE @lt_catego.
******** ZTB_CATEGO ********
    "fill internal table
    lt_clientes = VALUE #(
...
*    Modelo de datos  21
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_cliente_7143.
    INSERT ztb_cliente_7143 FROM TABLE @lt_clientes.
******** ZTB_CLNTS_LIB ********
    lt_clnts_lib = VALUE #(
...
*    Modelo de datos  22
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clt_lib_7143.
    INSERT ztb_clt_lib_7143 FROM TABLE @lt_clnts_lib.
******** ZTB_LIBROS ********
    "fill internal table
    lt_libros = VALUE #(
...
*    Modelo de datos   25
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    DELETE FROM ztb_libro_7143.
    INSERT ztb_libro_7143 FROM TABLE @lt_libros.
